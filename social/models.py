...
class UserProfile(models.Model):
	...
	picture = models.ImageField(upload_to='profile_images/%Y/%m/%d/', default='profile_images/default.png', blank=True)
...
class MessageModel(models.Model):
	...
	image = models.ImageField(upload_to='message_images/%Y/%m/%d/', blank=True, null=True)
	date = models.DateTimeField(default=timezone.now)
