...
function PostToogle() {
	const row = document.getElementById('show-post');
...
function ShareToogle(parent_id) {
	const row = document.getElementById(parent_id);
...
function clearPostForm() {
	let x = document.getElementById("clearForm").reset();
}

function formatTags() {
	const elements = document.getElementsByClassName('post-tags');
